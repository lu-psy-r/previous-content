...
## Overview: Quick start {#sec-report-intro}
...
- providing, for your convenience, a repeat presentation of the information you can find in the [previous guide](https://lu-psy-r.github.io/MSc/PSYC411/part2/report-preface.html)
...
If you want more in-depth guidance or support, we provide detailed *step-by-step* notes on the work you can plan to do in [the PSYC411 How chapter](https://lu-psy-r.github.io/MSc/PSYC411/part2/how.html).

If you want an explanation of *why* we are asking you to do this work, so you can think about best practice in science, we have got that for you in [the PSYC411 Why chapter](https://lu-psy-r.github.io/MSc/PSYC411/part2/intro.html).

## What you have to write {#sec-report-quick-what} 

Let's begin with what you need to write to complete this coursework.

1. **Submission deadline: On Wednesday 14th May 2025**
...
::: callout-tip
You will be able to find the submission point on Moodle [here](https://modules.lancaster.ac.uk/mod/assign/view.php?id=2512662) when it is revealed.
:::
...
::: callout-tip
If you want to know more about **how** to do this work, you can read in-depth step-by-step guidance in [the PSYC411 How chapter](https://lu-psy-r.github.io/MSc/PSYC411/part2/how.html).
:::
...
## Lectures and slides {#sec-report-intro-lecture}
