...
## 10.1 Overview {#sec-lm-dev-overview}
...
## 10.2 Our learning goals {#sec-lm-dev-goals}
...
## 10.3 Learning resources {#sec-lm-dev-resources}
...
::: callout-tip
## Linked resources
1. In [the chapter for week 7](../part2/hypotheses-associations.qmd#sec-associations-overview), we share materials to support your development of critical thinking about associations, and your development of practical skills in working with correlation-based analyses.
2. In [the chapter for week 8](../part2/lm-intro.qmd#sec-lm-intro-overview), we introduce you to the main ideas and practical steps involved in conducting linear model analyses.
:::

### 10.3.1 Lectures {#sec-lm-dev-lectures}
...
### 10.3.2 Lecture slides {#sec-lm-dev-lectures-slides}
...
### 10.4 Practical materials: data and R-Studio {#sec-lm-dev-practical}
...
### 10.4.1 Practical materials guide {#sec-lm-dev-practical-guide}
...
#### 10.4.1.1 The data files {#sec-lm-dev-practical-data}
...
#### 10.4.2 The how-to guide {#sec-lm-dev-practical-how-to}
...
#### 10.4.3 The practical exercises {#sec-lm-dev-practical-workbook}
