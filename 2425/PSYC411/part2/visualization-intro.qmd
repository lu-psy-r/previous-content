...
## 9.1 Overview {#sec-vis-intro-overview}
...
(You can read more about the project in [the chapter for week 7](../part2/hypotheses-associations.qmd#sec-associations-overview).)

## 9.2 Our learning goals {#sec-vis-intro-goals}
...
## 9.3 Learning resources {#sec-vis-intro-resources}
...
4. In PSYC413: in Week 9, in the *visualizations perspective* class, we explore more broadly why being able to produce and read data visualizations is now an important **sought-after skill**.
...
<!-- In [the Visualization chapter](../part2/visualization.qmd#sec-visualization-overview), we present **optional reading** if you want to extend your learning: a more extensive discussion of data visualization, enabling you to work with a wider range of visualizations for richer data-sets. -->
:::
...
### 9.3.1 Lectures {#sec-vis-intro-lectures}

The lecture materials for this week are presented in four short parts. 

Click on a link and your browser should open a tab showing the *Panopto* video for the lecture part.

1. Part 1 (14 minutes) **Data visualization perspectives and practices**: The concepts and skills we will learn about in week 9: what we will learn and how we will know if we have learned it, the different kinds of goals we think about when we make visualizations, discovery and communication.

```{=html}
<iframe src="https://lancaster.cloud.panopto.eu/Panopto/Pages/Embed.aspx?id=ec0ae3b2-03c3-422f-b021-b23600ca8ea3&autoplay=false&offerviewer=true&showtitle=true&showbrand=true&captions=false&interactivity=all" height="405" width="720" style="border: 1px solid #464646;" allowfullscreen allow="autoplay" aria-label="Panopto Embedded Video Player" aria-description="PSYC411-visualization-1" ></iframe>
```
...
### 9.3.2 Lecture slides {#sec-vis-intro-lectures-slides}

::: callout-tip
## Download the lecture slides
The slides presented in the videos can be downloaded here:

- [The slides](files/411-data-visualisation-practices.html) exactly as presented (7 MB). 
...
### 9.4 Practical materials: data and R-Studio {#sec-vis-intro-practical}
...
### 9.4.1 Practical materials guide {#sec-vis-intro-practical-guide}
...
#### 9.4.1.1 The data files {#sec-lm-intro-practical-data}
...
#### 9.4.2 The how-to guide {#sec-vis-intro-practical-how-to}
...
#### 9.4.3 The practical exercises {#sec-lm-intro-practical-workbook}
...
>**Pract.Q.2.** What does a boxplot represent? In other words, what summary
...
>**Pract.Q.3.** Can you find example code showing how to produce a boxplot that
...
> Pract.A.5. Overplotting refers to where points (or other objects) are printed
...
>**Pract.Q.7.** What does the plot tell you about the average (median) vocabulary (`SHIPLEY`) score recorded for people in the `study.two.gen` data-set
who report different education levels?

> Pract.A.7. The plot indicates that the median vocabulary score is higher for people who report `Higher` education compared to people who report `Further` education or people who report `Secondary` education.
...
>**Pract.Q.8.** What does the plot tell you about the individual, i.e., per-person
