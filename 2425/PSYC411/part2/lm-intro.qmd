...
## 8.1 Overview {#sec-lm-intro-overview}
...
## 8.2 Our learning goals {#sec-lm-intro-goals}
...
## 8.3 Learning resources {#sec-lm-intro-resources}
...
::: callout-tip
## Linked resources
- In [the chapter for week 7](../part2/hypotheses-associations.qmd#sec-associations-overview), we share materials to support your development of critical thinking about associations, and your development of practical skills in working with correlation-based analyses.
:::

### 8.3.1 Lectures {#sec-lm-intro-lectures}

The lecture materials for this week are presented in four short parts. 

Click on a link and your browser should open a tab showing the *Panopto* video for the lecture part.

1. Part 1 (12 minutes) **Focus on the linear model**: The concepts and skills we will learn about in week 8: our aims, the kind of questions we can answer with linear models, and how we get from those questions to sensible linear model analyses.

```{=html}
<iframe src="https://lancaster.cloud.panopto.eu/Panopto/Pages/Embed.aspx?id=eaf1c87a-87bb-491e-b33b-b22e0102965f&autoplay=false&offerviewer=true&showtitle=true&showbrand=true&captions=false&interactivity=all" height="405" width="720" style="border: 1px solid #464646;" allowfullscreen allow="autoplay" aria-label="Panopto Embedded Video Player" aria-description="PSYC411-lm-intro-1" ></iframe>
```
...
### 8.3.2 Lecture slides {#sec-lm-intro-lectures-slides}

::: callout-tip
## Download the lecture slides
The slides presented in the videos can be downloaded here:

- [The slides](files/411-linear-model-intro.html) exactly as presented (12 MB). 
...
## 8.4 Practical materials: data and R-Studio {#sec-lm-intro-practical}
...
### 8.4.1 Practical materials guide {#sec-lm-intro-practical-guide}
...
#### 8.4.1.1 The data files {#sec-lm-intro-practical-data}
...
### 8.4.2 The how-to guide {#sec-lm-intro-practical-how-to}
...
#### 8.4.3 The practical exercises {#sec-lm-intro-practical-workbook}
...
>**Pract.Q.5.** Can you add annotation: a vertical line to show the mean value of 
...
>**Pract.Q.6.** Where can you find information on how to define the limits on the x-axis 
and on the y-axis?
