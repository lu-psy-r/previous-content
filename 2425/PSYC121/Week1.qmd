...
# 1. Lectures for week 1

Watch the introduction: Lecture Part 1

```{=html}
<iframe src="https://lancaster.cloud.panopto.eu/Panopto/Pages/Embed.aspx?id=15a82586-1f14-467f-95c0-b1fc008c9139&autoplay=false&offerviewer=true&showtitle=true&showbrand=true&captions=false&interactivity=all" height="405" width="720" style="border: 1px solid #464646;" allowfullscreen allow="autoplay" aria-label="Panopto Embedded Video Player" aria-description="week 1(2024) part A" ></iframe>
```
Watch Lecture Part 2

```{=html}
<iframe src="https://lancaster.cloud.panopto.eu/Panopto/Pages/Embed.aspx?id=0cf1e5a7-fc48-4b7e-8ba2-b1fc009120db&autoplay=false&offerviewer=true&showtitle=true&showbrand=true&captions=false&interactivity=all" height="405" width="720" style="border: 1px solid #464646;" allowfullscreen allow="autoplay" aria-label="Panopto Embedded Video Player" aria-description="Week 1 (2024) part 2" ></iframe>
```
Watch Lecture Part 3

```{=html}
<iframe src="https://lancaster.cloud.panopto.eu/Panopto/Pages/Embed.aspx?id=3364ec5c-d02c-4774-9e1d-b1fc009709c1&autoplay=false&offerviewer=true&showtitle=true&showbrand=true&captions=false&interactivity=all" height="405" width="720" style="border: 1px solid #464646;" allowfullscreen allow="autoplay" aria-label="Panopto Embedded Video Player" aria-description="Week 1 (2024) part 3" ></iframe>
```
Watch Lecture Part 4

```{=html}
<iframe src="https://lancaster.cloud.panopto.eu/Panopto/Pages/Embed.aspx?id=30af9bcf-340f-4814-b386-b1fc009a676f&autoplay=false&offerviewer=true&showtitle=true&showbrand=true&captions=false&interactivity=all" height="405" width="720" style="border: 1px solid #464646;" allowfullscreen allow="autoplay" aria-label="Panopto Embedded Video Player" aria-description="Week 1 (2024) part D" ></iframe>
```
Download the lecture slides [here](data/Week_1/week_1_lecture_student_slides.pptx)

# 2. Analysis labs and 'pre-lab' activity
...
-   You have worked through the online "prelab" preparation materials - [You can access the link for Week 1 here](https://ma-rconnect.lancs.ac.uk/W1_prelab24/){target="_blank"}
...
![](images/Wk1/howell.png){fig-align="center" width="2in"}
...
# 3. Lab activities for this week

## Task 3.1 - check-in with the University attendance register
...
## Task 3.2 - Getting dicy

![](images/Wk1/dice.png){fig-align="center" width="3in"}
...
When RStudio starts, it will look something like this: ![Startup screen](images/Wk1/RStudio_starup_screen.png)
...
1.  Download the "zip" file by [clicking this link](data/Week_1/week_1.zip)
...
b)  End your session on the RStudio server, this logs you out of the server and stops any ongoing activities and tasks you have set up, maybe in the background.
    ...
    ![](images/Wk1/power_button.png){width="2.5in"}
...
## Task 3.4 -- Review the learnr sample / practice questions
...
## Task 3.5 -- Data collection exercise
...
The survey runs [by following this link](https://lancasteruni.eu.qualtrics.com/jfe/form/SV_0rJaVFmYy6ppcUu){target="_blank"}

## Post - lab recap: The slides we used

Want to see again the introduction slides that we used in the Levy lab? They are [available here](data/Week_1/week_1_lecture_student_slides.pptx)
