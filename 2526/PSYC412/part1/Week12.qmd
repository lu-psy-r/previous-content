...
::: {.callout-tip}
You'll find links to the slides and transcripts underneath each video. You can also download them all at once [here](Week12-files/412_week12_slidesAndTranscripts.zip)
:::
...
```
[Slides](Week12-files/stats_categoricalPredictors_theory_dis_1pp.pdf)
[Transcript](Week12-files/statscategoricalPredictorstheory.txt)
...
```
[Slides](Week12-files/stats_interactions_theory_dis_1pp.pdf)
[Transcript](Week12-files/statsinteractionstheory.txt)
...
```
[Slides](Week12-files/dataWrangling_dplyrPipes_slides_1pp.pdf)
[Transcript](Week12-files/05dwdplyrPipes.txt)
...
:::{.callout-tip collapse="true"}
## Hint
Use the `filter()` function, in combination with the logical operator for 'not'. See [**here**](https://r4ds.had.co.nz/transform.html?q=boolean#logical-operators) for more info on logical operators.
:::
...
## Tip
You can download the R-script that combines all these bits of code into 1 pipe [**here**](Week12-files/412_wk12_pre_lab_demographics.R). It is always a good idea to build a pipe like this 1 line at a time. Make sure to check that each line actually does what you expect it to do before you add the next line.
:::
...
Download the [412_week12_lab.zip](Week12-files/412_week12_lab.zip) file. 
...
![](Week12-files/wellbeingByScreentime.png)
...
You can download the R-script that includes the relevant code here: [412_wk12_labAct1_withAnswers.R](Week12-files/412_wk12_labAct1_withAnswers.R).
