...
> Pract.A.9. It can be seen that the estimated effect of portuguese varies between the models but the estimate is more similar, around .65, where the random effect is specified as
