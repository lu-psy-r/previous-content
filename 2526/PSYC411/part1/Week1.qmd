...
## Help! I'm getting the error "HTTP Error 400. The size of the request headers is too long." when I try to watch a video, what do I do?
You will need to clear out the cookies and cache from your browser. 
[for safari](https://support.apple.com/en-gb/guide/safari/sfri11471/16.1/mac/13.0){target="_blank"}.
[for chrome](https://support.google.com/accounts/answer/32050?hl=en&co=GENIE.Platform%3DDesktop){target="_blank"}.
[for microsoft edge](https://www.microsoft.com/en-us/edge/learning-center/how-to-manage-and-clear-your-cache-and-cookies?form=MA13I2){target="_blank"}.
:::
...
```{=html}
<iframe src="https://lancaster.cloud.panopto.eu/Panopto/Pages/Embed.aspx?id=7b94cdef-6407-4369-9423-b1fc0087f221&autoplay=false&offerviewer=true&showtitle=true&showbrand=true&captions=false&interactivity=all" height="405" width="720" style="border: 1px solid #464646;" allowfullscreen allow="autoplay" aria-label="Panopto Embedded Video Player" aria-description="psyc411 2025 w1 p1" ></iframe>

```

Watch Lecture week1 part2, stop halfway through and do the Lecture week1 part2 quiz (not assessed), by clicking [here](https://modules.lancaster.ac.uk/mod/quiz/view.php?id=2680943){target="_blank"}
Then come back and watch the end of Lecture week 1 part2:

```{=html}
<iframe src="https://lancaster.cloud.panopto.eu/Panopto/Pages/Embed.aspx?id=2d1319ad-9f0b-4ec7-865f-ac4c00b40487&autoplay=false&offerviewer=true&showtitle=true&showbrand=true&captions=false&interactivity=all" height="405" width="720" style="border: 1px solid #464646;" allowfullscreen allow="autoplay" aria-label="Panopto Embedded Video Player" aria-description="psyc411_2025_w1_p2" ></iframe>
```
...
```{=html}
<iframe src="https://lancaster.cloud.panopto.eu/Panopto/Pages/Embed.aspx?id=fb0627af-75d6-4f12-81f2-b091008d8793&autoplay=false&offerviewer=true&showtitle=true&showbrand=true&captions=false&interactivity=all" height="405" width="720" style="border: 1px solid #464646;" allowfullscreen allow="autoplay" aria-label="Panopto Embedded Video Player" aria-description="psyc411 2025 w1 p3" ></iframe>
```

Take the quiz on the lecture material (not assessed), by clicking [here](https://modules.lancaster.ac.uk/mod/quiz/view.php?id=2680944){target="_blank"}
...
and come prepared to the practical class to go through the tasks and ask your questions.
...
21.	What is the mean and standard deviation of annie_z’s standardised scores?
...
22.	You can have a look at the standardised scores of annie, by just typing `annie_z`. What z score corresponds to annie’s highest initial score of 95?
...
31.	Assign the sequence generated in step 30 to a new object. Now compute the mean of the sequence of numbers. (remember that objects can be a single number, or a sequence of numbers (called an array or a vector) or anything you want to put into it – remember, think of objects as buckets).
...
[Mona Chalabi on 3 ways to spot a bad statistic](https://www.ted.com/talks/mona_chalabi_3_ways_to_spot_a_bad_statistic){target="_blank"}.

[Susan Etlinger on the importance of understanding data](https://www.ted.com/talks/susan_etlinger_what_do_we_do_with_all_this_big_data?language=en){target="_blank"}.

[Luciana Padua on how to think critically about patterns in data](https://www.ted.com/talks/luciana_padua_data_literacy_and_the_art_of_asking_questions){target="_blank"}.
